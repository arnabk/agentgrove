...
| **Worktree Sessions** — start isolated workspaces per Git branch | _Coming soon_ |
| **Revert with AI** — ask the agent to undo the last commit | _Coming soon_ |
| **Queue Thoughts** — queue multiple prompts and wait for each to finish | _Coming soon_ |
| **Git Diff View** — inspect staged and unstaged changes | _Coming soon_ |
